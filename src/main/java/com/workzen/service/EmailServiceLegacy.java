...
public class EmailServiceLegacy {
    ...
    @Value("${spring.mail.from:noreply@workzen.com}")
    ...
    public void sendWelcomeEmail(String toEmail, String employeeId, String firstName, String lastName, String tempPassword) {
        if (!emailEnabled) {
            log.info("Email sending is disabled. Welcome email for {} would have been sent to: {}", employeeId, toEmail);
            log.info("Employee Credentials - ID: {}, Password: {}", employeeId, tempPassword);
            return;
        }
    ...
    public void sendPasswordResetEmail(String toEmail, String employeeId, String firstName, String newPassword) {
        if (!emailEnabled) {
            log.info("Email sending is disabled. Password reset email for {} would have been sent to: {}", employeeId, toEmail);
            log.info("New Password for {}: {}", employeeId, newPassword);
            return;
        }
    ...
    public void sendAccountActivationEmail(String toEmail, String employeeId, String firstName) {
        if (!emailEnabled) {
            log.info("Email sending is disabled. Account activation email for {} would have been sent to: {}", employeeId, toEmail);
            return;
        }
